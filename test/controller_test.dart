...
main() {
  ...
  group('signInUser', () {
    ...
    test('returns a UserData object as the data property of the APIResponse object if the http call completes successfully and the role is a passenger', () async {
      ...
      {
    "message": "Sign in success",
    "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiJZUzFNUFNTbXJiUmhCWm5sY3pmRjBCYlhsYTAyIiwiaWF0IjoxNTg1ODM5NzI2LCJleHAiOjE1ODY0NDQ1MjZ9.77BQhSH4W6I78GhlMKJiZWKoikp-ma0AWc6tkEhNJno",
    "user": {
        "user": {
            "user": {
