...
//   BusBook({this.uid, this.token, this.count, this.selectedSeatNumbers, this.busType, this.totalPrice, this.startStation, this.endStation, this.trip});
...
//                           // trip: widget.trip,
//                           // trip: BusTripData(tripId: route.tripId, ),
